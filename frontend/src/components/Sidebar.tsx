...
import { LayoutDashboard, MessageSquare, PieChart, Settings, HardDrive, Archive, History, Trash2 } from 'lucide-react';
...
export function Sidebar({ mirrorEnabled }: SidebarProps) {
    const navItems = [
        {
            ...
            ? [
                {
                    ...
                    gradient: 'from-emerald-300/20 to-teal-300/20',
                ...
                },
                {
                    ...
                    label: 'Edit History',
                    to: '/edit-history',
                    gradient: 'from-blue-300/20 to-indigo-300/20',
                ...
                },
                {
                    ...
                    to: '/deleted-messages',
                    gradient: 'from-red-300/20 to-rose-300/20',
